<template>
  ...
  <!-- <p class="btn-container"><Button>dfdsfs</Button></p> -->
  
  <!-- <div class="btn-container">
    <Button v-for="i in Button" 
            :key="i.Button"
            :btnbgcolor="i.btnbgcolor" 
            :btntext="i.btntext" >
    </Button>
  ...
  data(){
    return{
      ...
      Promotion: [
        ...
        {
          colorBackground: "#F3E8E8",
          productImages: "./src/assets/juice.png",  
